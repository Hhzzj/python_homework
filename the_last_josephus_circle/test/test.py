...
from src.usecase.read_different_types_files import ZipReader
from src.usecase.read_different_types_files import CsvReader
from src.usecase.read_different_types_files import ExcelReader
from src.usecase.get_people_list import get_people_list
from src.usecase.entity.josephus import JosephusCircle
from src.usecase.entity.person import Person
...
class TestExcelReader(unittest.TestCase):
    def test_excel_reader(self):
        read_list = ExcelReader(r"src\usecase\entity\peopledata\lastname&firstname&id.xls").read()
        self.assertEqual(CORRECT_LIST,read_list)

class TestCsvReader(unittest.TestCase):
    def test_csv_reader(self):
        read_list = CsvReader(r"src\usecase\entity\peopledata\lastname&firstname&id.csv").read()
        self.assertEqual(CORRECT_LIST,read_list)

class TestZipReader(unittest.TestCase):
    def test_zip_reader(self):
        read_list = ZipReader(r"src\usecase\entity\peopledata\lastname&firstname&id.zip","lastname&firstname&id.csv").read()
        self.assertEqual(CORRECT_LIST,read_list)
